...
def generate_images(extracted_content_path=EXTRACTED_CONTENT_PATH, output_path=OUTPUT_PATH, all_combinations=False,
    ...
    for combination in combinations:
        ...
        img.save(f"{output_path}/{combination_str}.jpg")
...
def lsr_to_jpg(input_file_path, output_path, all_combinations, background_layer):
    ...
    generate_images(output_path=output_path, all_combinations=all_combinations, background_layer=background_layer)
